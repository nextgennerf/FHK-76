...
"QRadioButton::indicator::checked{border: 10px solid #61136E; width: 10px; height: 10px;}")
        ...
        self.rotateCC = QtWidgets.QPushButton(self.gridLayoutWidget_3)
        self.rotateCC.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.rotateCC.sizePolicy().hasHeightForWidth())
        self.rotateCC.setSizePolicy(sizePolicy)
        self.rotateCC.setMinimumSize(QtCore.QSize(65, 65))
        font = QtGui.QFont()
        font.setFamily("Wingdings 3")
        font.setPointSize(50)
        self.rotateCC.setFont(font)
        self.rotateCC.setStyleSheet("QPushButton {\n"
"    border: 3px solid #61136E;\n"
"    border-radius: 8px;\n"
"    background-color: #FFFFFF;\n"
"    color: #000000;\n"
"}")
        self.rotateCC.setCheckable(True)
        self.rotateCC.setChecked(True)
        self.rotateCC.setObjectName("rotateCC")
        self.directionButtons = QtWidgets.QButtonGroup(MainWindow)
        self.directionButtons.setObjectName("directionButtons")
        self.directionButtons.addButton(self.rotateCC)
        self.rotationOptions.addWidget(self.rotateCC)
...
"}")
        ...
        self.rotateCheckBox.toggled['bool'].connect(self.rotateCC.setEnabled)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rotateCC.setText(_translate("MainWindow", ""))
