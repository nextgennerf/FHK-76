...
"}")
        ...
        self.layoutWidget = QtWidgets.QWidget(self.frontPattern)
        self.layoutWidget.setGeometry(QtCore.QRect(0, 0, 801, 251))
        self.layoutWidget.setObjectName("layoutWidget")
        self.frontPatternLayout = QtWidgets.QHBoxLayout(self.layoutWidget)
        self.frontPatternLayout.setSizeConstraint(QtWidgets.QLayout.SetDefaultConstraint)
        self.frontPatternLayout.setContentsMargins(0, 0, 0, 0)
        self.frontPatternLayout.setSpacing(15)
        self.frontPatternLayout.setObjectName("frontPatternLayout")
        self.patternButtonStack = QtWidgets.QVBoxLayout()
        self.patternButtonStack.setSpacing(0)
        self.patternButtonStack.setObjectName("patternButtonStack")
        self.frontStaticButton = QtWidgets.QRadioButton(self.layoutWidget)
...
"QRadioButton::indicator::checked{border: 10px solid #61136E; width: 10px; height: 10px;}")
        ...
        self.patternButtonStack.addWidget(self.frontStaticButton)
        self.frontBreatheButton = QtWidgets.QRadioButton(self.layoutWidget)
...
"QRadioButton::indicator::checked{border: 10px solid #61136E; width: 10px; height: 10px;}")
        ...
        self.patternButtonStack.addWidget(self.frontBreatheButton)
        self.frontSolidSpinButton = QtWidgets.QRadioButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"QRadioButton::indicator::checked{border: 10px solid #61136E; width: 10px; height: 10px;}")
        ...
        self.patternButtonStack.addWidget(self.frontSolidSpinButton)
        self.frontFadeSpinButton = QtWidgets.QRadioButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"QRadioButton::indicator::checked{border: 10px solid #61136E; width: 10px; height: 10px;}")
        ...
        self.patternButtonStack.addWidget(self.frontFadeSpinButton)
        self.frontRainbowButton = QtWidgets.QRadioButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"QRadioButton::indicator::checked{border: 10px solid #61136E; width: 10px; height: 10px;}")
        ...
        self.patternButtonStack.addWidget(self.frontRainbowButton)
        self.rotationButtons = QtWidgets.QHBoxLayout()
        self.rotationButtons.setSpacing(0)
        self.rotationButtons.setObjectName("rotationButtons")
        self.rotateCW = QtWidgets.QPushButton(self.layoutWidget)
        self.rotateCW.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.rotateCW.sizePolicy().hasHeightForWidth())
        self.rotateCW.setSizePolicy(sizePolicy)
        self.rotateCW.setMinimumSize(QtCore.QSize(50, 50))
        font = QtGui.QFont()
        font.setFamily("Wingdings 3")
        font.setPointSize(30)
        self.rotateCW.setFont(font)
        self.rotateCW.setStyleSheet("QPushButton {\n"
"    border: 3px solid #61136E;\n"
"    border-radius: 8px;\n"
"    background-color: #FFFFFF;\n"
"    color: #000000;\n"
"}")
        self.rotateCW.setCheckable(True)
        self.rotateCW.setChecked(True)
        self.rotateCW.setObjectName("rotateCW")
        self.directionButtons = QtWidgets.QButtonGroup(MainWindow)
        self.directionButtons.setObjectName("directionButtons")
        self.directionButtons.addButton(self.rotateCW)
        self.rotationButtons.addWidget(self.rotateCW)
        self.rotateCCW = QtWidgets.QPushButton(self.layoutWidget)
        self.rotateCCW.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.rotateCCW.sizePolicy().hasHeightForWidth())
        self.rotateCCW.setSizePolicy(sizePolicy)
        self.rotateCCW.setMinimumSize(QtCore.QSize(50, 50))
        font = QtGui.QFont()
        font.setFamily("Wingdings 3")
        font.setPointSize(30)
        font.setBold(False)
        ...
        self.rotateCCW.setFont(font)
        self.rotateCCW.setStyleSheet("QPushButton {\n"
"    border: 3px solid #61136E;\n"
"    border-radius: 8px;\n"
"    background-color: #FFFFFF;\n"
"    color: #000000;\n"
"}")
        self.rotateCCW.setCheckable(True)
        self.rotateCCW.setObjectName("rotateCCW")
        self.directionButtons.addButton(self.rotateCCW)
        self.rotationButtons.addWidget(self.rotateCCW)
        self.patternButtonStack.addLayout(self.rotationButtons)
        self.frontPatternLayout.addLayout(self.patternButtonStack)
        self.animationTimeStack = QtWidgets.QVBoxLayout()
        self.animationTimeStack.setObjectName("animationTimeStack")
        self.ANIMATION = QtWidgets.QLabel(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.animationTimeStack.addWidget(self.ANIMATION)
        self.timeDial = QtWidgets.QDial(self.layoutWidget)
        ...
        self.animationTimeStack.addWidget(self.timeDial)
        ...
        self.animationTimeStack.addWidget(self.timeLabel)
        self.frontPatternLayout.addLayout(self.animationTimeStack)
        ...
        self.countStack.addWidget(self.COUNT)
        self.button2 = QtWidgets.QRadioButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"QRadioButton::indicator::checked{border: 8px solid #61136E; width: 8px; height: 8px;}")
        ...
        self.countStack.addWidget(self.button2)
        self.button3 = QtWidgets.QRadioButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"QRadioButton::indicator::checked{border: 8px solid #61136E; width: 8px; height: 8px;}")
        ...
        self.countStack.addWidget(self.button3)
        self.button4 = QtWidgets.QRadioButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"QRadioButton::indicator::checked{border: 8px solid #61136E; width: 8px; height: 8px;}")
        ...
        self.countStack.addWidget(self.button4)
        self.button6 = QtWidgets.QRadioButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"QRadioButton::indicator::checked{border: 8px solid #61136E; width: 8px; height: 8px;}")
        ...
        self.countStack.addWidget(self.button6)
        self.button8 = QtWidgets.QRadioButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"QRadioButton::indicator::checked{border: 8px solid #61136E; width: 8px; height: 8px;}")
        ...
        self.countStack.addWidget(self.button8)
        self.button12 = QtWidgets.QRadioButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"QRadioButton::indicator::checked{border: 8px solid #61136E; width: 8px; height: 8px;}")
        ...
        self.countStack.addWidget(self.button12)
        self.button24 = QtWidgets.QRadioButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"QRadioButton::indicator::checked{border: 8px solid #61136E; width: 8px; height: 8px;}")
        ...
        self.countStack.addWidget(self.button24)
        self.frontPatternLayout.addLayout(self.countStack)
        self.layoutStack = QtWidgets.QVBoxLayout()
        self.layoutStack.setContentsMargins(0, -1, -1, -1)
        self.layoutStack.setSpacing(0)
        self.layoutStack.setObjectName("layoutStack")
        self.layoutImage = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.layoutStack.addWidget(self.layoutImage)
        ...
        self.altLayoutCheckBox = QtWidgets.QCheckBox(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"QCheckBox::indicator:checked {image: url(checkmark.png);}")
        ...
        self.horizontalLayout.addWidget(self.altLayoutCheckBox)
        spacerItem1 = QtWidgets.QSpacerItem(5, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem1)
        self.layoutStack.addLayout(self.horizontalLayout)
        self.frontPatternLayout.addLayout(self.layoutStack)
        ...
        self.widget = QtWidgets.QWidget(self.frontColor)
        self.widget.setGeometry(QtCore.QRect(0, 0, 803, 251))
        self.widget.setObjectName("widget")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_4.setSpacing(15)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.colorButtonStack = QtWidgets.QVBoxLayout()
        self.colorButtonStack.setSpacing(0)
        self.colorButtonStack.setObjectName("colorButtonStack")
        self.singleButton = QtWidgets.QRadioButton(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"\n"
"QRadioButton::indicator{border: 3px solid #000000; border-radius: 12px; background-color: #FFFFFF; width: 20px; height: 20px; margin-left: 5px; margin-right: 5px;}\n"
"\n"
"QRadioButton::indicator::checked{border: 8px solid #61136E; width: 8px; height: 8px;}")
        ...
        self.colorButtonStack.addWidget(self.singleButton)
        self.rainbowButton = QtWidgets.QRadioButton(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"QRadioButton::indicator::checked{border: 8px solid #61136E; width: 8px; height: 8px;}")
        ...
        self.colorButtonStack.addWidget(self.rainbowButton)
        self.rgbButton = QtWidgets.QRadioButton(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"QRadioButton::indicator::checked{border: 8px solid #61136E; width: 8px; height: 8px;}")
        ...
        self.colorButtonStack.addWidget(self.rgbButton)
        self.ycmButton = QtWidgets.QRadioButton(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"QRadioButton::indicator::checked{border: 8px solid #61136E; width: 8px; height: 8px;}")
        ...
        self.colorButtonStack.addWidget(self.ycmButton)
        self.rygcbmButton = QtWidgets.QRadioButton(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"QRadioButton::indicator::checked{border: 8px solid #61136E; width: 8px; height: 8px;}")
        ...
        self.colorButtonStack.addWidget(self.rygcbmButton)
        self.horizontalLayout_4.addLayout(self.colorButtonStack)
        self.colorOptions = QtWidgets.QStackedWidget(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.colorOptions.sizePolicy().hasHeightForWidth())
        self.colorOptions.setSizePolicy(sizePolicy)
        self.colorOptions.setMinimumSize(QtCore.QSize(650, 0))
        self.colorOptions.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.colorOptions.setObjectName("colorOptions")
        self.cycleOption = QtWidgets.QWidget()
        self.cycleOption.setObjectName("cycleOption")
        self.horizontalLayoutWidget_4 = QtWidgets.QWidget(self.cycleOption)
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(0, 0, 651, 251))
        self.horizontalLayoutWidget_4.setObjectName("horizontalLayoutWidget_4")
        self.cycleLayout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_4)
        self.cycleLayout.setContentsMargins(10, 0, 10, 0)
        self.cycleLayout.setSpacing(0)
        self.cycleLayout.setObjectName("cycleLayout")
        self.CYCLE = QtWidgets.QLabel(self.horizontalLayoutWidget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.cycleLayout.addWidget(self.CYCLE)
        self.cycleDial = QtWidgets.QDial(self.horizontalLayoutWidget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cycleDial.sizePolicy().hasHeightForWidth())
        self.cycleDial.setSizePolicy(sizePolicy)
        self.cycleDial.setMinimumSize(QtCore.QSize(300, 0))
        self.cycleDial.setMinimum(5)
        self.cycleDial.setMaximum(30)
        self.cycleDial.setPageStep(5)
        self.cycleDial.setNotchesVisible(True)
        self.cycleDial.setObjectName("cycleDial")
        self.cycleLayout.addWidget(self.cycleDial)
        self.cycleLabel = QtWidgets.QLabel(self.horizontalLayoutWidget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cycleLabel.sizePolicy().hasHeightForWidth())
        self.cycleLabel.setSizePolicy(sizePolicy)
        self.cycleLabel.setMinimumSize(QtCore.QSize(30, 0))
        font = QtGui.QFont()
        font.setFamily("Droid")
        font.setPointSize(20)
        self.cycleLabel.setFont(font)
        self.cycleLabel.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.cycleLabel.setObjectName("cycleLabel")
        self.cycleLayout.addWidget(self.cycleLabel)
        self.SECONDS = QtWidgets.QLabel(self.horizontalLayoutWidget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.SECONDS.sizePolicy().hasHeightForWidth())
        self.SECONDS.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Droid")
        font.setPointSize(20)
        self.SECONDS.setFont(font)
        self.SECONDS.setObjectName("SECONDS")
        self.cycleLayout.addWidget(self.SECONDS)
        self.colorOptions.addWidget(self.cycleOption)
        self.colorOption = QtWidgets.QWidget()
        self.colorOption.setObjectName("colorOption")
        self.widget1 = QtWidgets.QWidget(self.colorOption)
        self.widget1.setGeometry(QtCore.QRect(0, 0, 651, 251))
        self.widget1.setObjectName("widget1")
        self.singleLayout = QtWidgets.QHBoxLayout(self.widget1)
        self.singleLayout.setContentsMargins(10, 0, 10, 0)
        self.singleLayout.setSpacing(0)
        self.singleLayout.setObjectName("singleLayout")
        self.HUE = QtWidgets.QLabel(self.widget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.HUE.setAlignment(QtCore.Qt.AlignCenter)
        self.HUE.setObjectName("HUE")
        self.singleLayout.addWidget(self.HUE)
        self.hueDial = QtWidgets.QDial(self.widget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.hueDial.sizePolicy().hasHeightForWidth())
        self.hueDial.setSizePolicy(sizePolicy)
        self.hueDial.setMinimumSize(QtCore.QSize(249, 0))
        self.hueDial.setMaximum(360)
        self.hueDial.setPageStep(12)
        self.hueDial.setProperty("value", 0)
        self.hueDial.setSliderPosition(0)
        ...
        self.hueLabel = QtWidgets.QLabel(self.widget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"background-color: rgb(255,0,0);")
        ...
        spacerItem2 = QtWidgets.QSpacerItem(74, 20, QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
        self.singleLayout.addItem(spacerItem2)
        self.colorOptions.addWidget(self.colorOption)
        self.horizontalLayout_4.addWidget(self.colorOptions)
        ...
        self.cycleDial.valueChanged['int'].connect(self.cycleLabel.setNum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rotateCW.setText(_translate("MainWindow", ""))
        self.rotateCCW.setText(_translate("MainWindow", ""))
        ...
        self.CYCLE.setText(_translate("MainWindow", "cycle time:"))
        self.cycleLabel.setText(_translate("MainWindow", "30"))
